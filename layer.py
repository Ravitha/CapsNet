...
# Implementation of the activation whereby the vector values are squashed
# between 0 to 1
...
class CapsuleLayer(layers.Layer):
    ...
    def __init__(self, num_capsule, dim_capsule, routings=3, kernel_initializer='glorot_uniform',**kwargs):
        ...
        self.num_capsule = num_capsule #Ref:number of classes
        self.dim_capsule = dim_capsule
        self.routings = routings #Ref:number of routing iterations
    ...
    def build(self, input_shape):
        ...
        # Transform matrix
        self.W = self.add_weight(name = 'W', shape=[self.num_capsule, self.input_num_capsule,self.dim_capsule, self.input_dim_capsule], trainable=True)
